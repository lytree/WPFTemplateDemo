...
namespace WPFTemplate.Service.Data;
...
public class DataService
{
    ...
    internal List<ViewsDataModel> GetDemoDataList()
    {
        ...
        for (var i = 1; i <= 20; i++)
        {
            ...
            var model = new ViewsDataModel
            {
                ...
                Type = (DemoType)(i % 6 + 1),
                DataList = dataList,
                ImgPath = $"/WPFTemplate;component/Resources/Img/Avatar/avatar{i % 6 + 1}.png",
    ...
    internal List<ViewsDataModel> GetDemoDataList(int count)
    {
        ...
        for (var i = 1; i <= count; i++)
        {
            ...
            var model = new ViewsDataModel
            {
                ...
                Name = $"Name{i}",
                Type = (DemoType)index,
                ImgPath = $"/WPFTemplate;component/Resources/Img/Avatar/avatar{index}.png",
                Remark = new string(i.ToString()[0], 10)
            };
            list.Add(model);
        }
    ...
    internal List<AvatarModel> GetContributorDataList()
    {
        ...
        try
        {
            var json = client.GetStringAsync(new Uri("https://api.github.com/repos/nabian/handycontrol/contributors"));
            var objList = JsonConvert.DeserializeObject<List<dynamic>>(json.Result);
        ...
        {
            HandyControl.Controls.MessageBox.Error(e.Message, "错误");
        }
    ...
    internal ObservableCollection<CardModel> GetCardDataList()
    {
        return new()
        {
            ...
            {
                Header = "Atomic",
                Content = "/WPFTemplate;component/Resources/Img/Album/1.jpg",
                Footer = "Stive Morgan"
            },
            new CardModel
            {
                Header = "Zinderlong",
                Content = "/WPFTemplate;component/Resources/Img/Album/2.jpg",
                Footer = "Zonderling"
            },
            new CardModel
            {
                Header = "Busy Doin' Nothin'",
                Content = "/WPFTemplate;component/Resources/Img/Album/3.jpg",
                Footer = "Ace Wilder"
            },
            new CardModel
            {
                Header = "Wrong",
                Content = "/WPFTemplate;component/Resources/Img/Album/4.jpg",
                Footer = "Blaxy Girls"
            },
            new CardModel
            {
                Header = "The Lights",
                Content = "/WPFTemplate;component/Resources/Img/Album/5.jpg",
                Footer = "Panda Eyes"
            },
            new CardModel
            {
                Header = "EA7-50-Cent Disco",
                Content = "/WPFTemplate;component/Resources/Img/Album/6.jpg",
                Footer = "еяхат музыка"
            },
            new CardModel
            {
                Header = "Monsters",
                Content = "/WPFTemplate;component/Resources/Img/Album/7.jpg",
                Footer = "Different Heaven"
            },
            new CardModel
            {
                Header = "Gangsta Walk",
                Content = "/WPFTemplate;component/Resources/Img/Album/8.jpg",
                Footer = "Illusionize"
            },
            new CardModel
            {
                Header = "Won't Back Down",
                Content = "/WPFTemplate;component/Resources/Img/Album/9.jpg",
                Footer = "Boehm / Benjamin Francis Leftwich"
            },
            new CardModel
            {
                Header = "Katchi",
                Content = "/WPFTemplate;component/Resources/Img/Album/10.jpg",
    ...
    internal CardModel GetCardData()
    {
        return new()
        {
            Content = $"/WPFTemplate;component/Resources/Img/Album/{DateTime.Now.Second % 10 + 1}.jpg"
        };
    }
    ...
    internal ObservableCollection<CoverViewDemoModel> GetCoverViewDemoDataList()
    {
        return new()
        {
            ...
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/1.jpg",
                BackgroundToken = ResourceToken.SuccessBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/2.jpg",
                BackgroundToken = ResourceToken.PrimaryBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/3.jpg",
                BackgroundToken = ResourceToken.WarningBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/4.jpg",
                BackgroundToken = ResourceToken.DangerBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/5.jpg",
                BackgroundToken = ResourceToken.SuccessBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/6.jpg",
                BackgroundToken = ResourceToken.PrimaryBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/7.jpg",
                BackgroundToken = ResourceToken.InfoBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/8.jpg",
                BackgroundToken = ResourceToken.WarningBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/9.jpg",
                BackgroundToken = ResourceToken.PrimaryBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/WPFTemplate;component/Resources/Img/Album/10.jpg",
                BackgroundToken = ResourceToken.DangerBrush
            }
        };
    }
